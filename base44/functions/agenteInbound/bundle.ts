...
// La fuente editable es entry.ts + _core/; esto es su aplanado (30 modulos
...
async function firmaMetaValida(
  rawBody: ArrayBuffer,
  header: string | null,
  secret: string,
): Promise<boolean> {
...
function secretoIgual(recibido: string | null, esperado: string): boolean {
